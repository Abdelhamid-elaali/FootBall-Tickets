<x-app-layout>
    <div class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h2 class="text-3xl font-bold text-gray-900 mb-8 text-center">Upcoming Matches</h2>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 text-center md:text-left justify-items-center md:justify-items-start">
            ...
            <div class="text-white max-w-sm">
                ...
                <p class="text-green-100">Your trusted source for football match tickets. Making it easy to attend the games you love.</p>
            </div>
            ...
            <div class="text-white">
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-green-100 hover:text-white transition-colors duration-300">How It Works</a></li>
                    <li><a href="#" class="text-green-100 hover:text-white transition-colors duration-300">FAQs</a></li>
                    <li><a href="#" class="text-green-100 hover:text-white transition-colors duration-300">Terms of Service</a></li>
                    <li><a href="#" class="text-green-100 hover:text-white transition-colors duration-300">Privacy Policy</a></li>
                </ul>
            </div>
            ...
            <div class="text-white">
                ...
                <ul class="space-y-2">
                <li class="text-green-100 flex items-center gap-2">
        ...
        <div class="mt-8 border-t border-green-500 pt-6 text-center text-green-200">
            Powered by FootballTix
        </div>
    </div>
        </footer>
                <!-- Bottom Footer -->
        ...
        <div class="mx-auto max-w-7xl px-6 py-4 md:flex md:items-center md:justify-between lg:px-8">
            <div class="flex justify-center space-x-6 md:order-2">
                <a href="https://www.facebook.com/share/14ph7jUqq7c/" class="text-gray-400 hover:text-gray-500">
                ...
                <a href="https://www.instagram.com/vtx__007?igsh=M2lwZDhqeGdvaTQ1" class="text-gray-400 hover:text-gray-500">
                ...
                <a href="https://wa.me/+212684121780" class="text-gray-400 hover:text-gray-500">
                ...
                <a href="https://x.com/vtx__007?t=CX-kK_qGlI8uuLcZWx6m-Q&s=09" class="text-gray-400 hover:text-gray-500">
            ...
            <div class="mt-8 md:order-1 md:mt-0">
                <p class="text-center text-xs leading-5 text-gray-500">&copy; 2024 FootballTix. All rights reserved.</p>
            </div>
        </div>
    </footer>
</x-app-layout>
