        ...
        <div class="flex h-screen bg-gray-100">
            ...
            <div class="hidden md:flex md:flex-shrink-0">
                <div class="flex flex-col w-64">
                    <div class="flex flex-col flex-grow pt-4 overflow-y-auto bg-green-700 border-r">
                        ...
                        <a href="{{ route('home') }}" class="flex items-center px-4 py-5 text-sm font-medium transition-colors duration-150 {{ request()->routeIs('home') ? 'text-white bg-green-800' : 'text-green-100 hover:bg-green-800' }} rounded-lg">
                        ...
                        <nav class="flex-1 space-y-1 mt-8">
                            ...
                            <a href="{{ route('admin.bookings') }}" class="flex items-center px-4 py-2.5 text-sm font-medium transition-colors duration-150 {{ request()->routeIs('admin.bookings') ? 'text-white bg-green-800' : 'text-green-100 hover:bg-green-800' }} rounded-lg">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex flex-shrink-0 p-4 border-t border-green-800">
