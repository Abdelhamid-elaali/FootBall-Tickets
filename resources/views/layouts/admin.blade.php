            ...
            <div class="hidden md:flex md:flex-shrink-0">
                <div class="flex flex-col w-64">
                    <div class="flex flex-col flex-grow py-4 overflow-y-auto bg-black border-r">
                        ...
                        <a href="{{ route('home') }}" class="flex items-center px-4 py-4 text-sm font-medium transition-colors duration-150 {{ request()->routeIs('home') ? 'text-white bg-green-800' : 'text-green-100 bg-gradient-to-r hover:from-green-900 hover:to-green-400 hover:opacity-100' }} rounded-lg">
